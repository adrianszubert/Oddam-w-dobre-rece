      ...
      <div className='contact-heading-form-wrapper'>
        ...
        <form className='contact-form'>
          <div className='input-wrapper'>
            <label className='form-label' for="name">Wpisz swoje imię</label>
            <input type="text" id="name" placeholder="Krzysztof"/>
          </div>
          <div className='input-wrapper'>
            <label className='form-label' for="email">Wpisz swój email</label>
            <input type="email" id="email" placeholder="abc@xyz.pl"/>
          </div>
          <div className='input-wrapper'>
            <label className='form-label' for="message">Wpisz swoją wiadomość</label>
            <textarea
              name="message"
              id="message"
              cols="30"
